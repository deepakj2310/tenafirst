<?php
/**
 * Kivicare\Utility\Nav_Menus\Component class
 *
 * @package kivicare
 */

namespace Kivicare\Utility\Nav_Menus;
 ...
 * * `kivicare()->is_primary_nav_menu_active()`
 * * `kivicare()->display_primary_nav_menu( array $args = array() )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				static::PRIMARY_NAV_MENU_SLUG => esc_html__( 'Top', 'kivicare' ),
				'kivi-departments-menu' => esc_html__( 'Iqonic Menu', 'kivicare' ),
			),
		);
	}

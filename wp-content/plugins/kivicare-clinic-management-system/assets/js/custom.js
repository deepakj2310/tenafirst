...
function kivicareCustomImageUploader(formTranslation,type='',multiple=false){
    let options = {
        title: ['report','csv','xls','json'].includes(type) ?  formTranslation.common.choose_file : formTranslation.common.choose_image,
        button: {
            text: ['report','csv','xls','json'].includes(type) ?  formTranslation.common.choose_file : formTranslation.common.choose_image
        },
        library: {
            type: [ 'image' ]
        },
    ...
    return  wp.media.frames.file_frame = wp.media(options);
}
...
$data = [
    ...
    "zoom_telemeted" => [
        "zoom_telemeted" => __("Zoom Telemeted",'kc-lang'),
        "zoom_telemeted_oauth" => __("Zoom Telemeted Oauth",'kc-lang'),
        "zoom_configuration" => __("Zoom Telemeted Configuration",'kc-lang'),
        "zoom_client_id" => __("Zoom Telemeted Client ID", "kc-lang"),
        "zoom_client_id_required" => __("Zoom Telemeted Client ID is required", "kc-lang"),
        "zoom_client_secret" => __("Zoom Telemeted Client Secret", "kc-lang"),
        "zoom_client_secret_required" => __("Zoom Telemeted Client Secret is required", "kc-lang"),
        "zoom_telemeted_intergration" => __("Zoom Telemeted Integration", "kc-lang"),
        "guide_to_setup_zoom" => __("Guide to setup Zoom.", "kc-lang"),
        "please_connect_zoom_telemeted_service" => __("Please Connect With Your Zoom Account To Use Zoom Telemeted Service.", "kc-lang"),
        "connected_zoom_telemeted_service" => __("You are connected with the Zoom.", "kc-lang"),
